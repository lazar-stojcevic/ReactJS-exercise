...
export default {
  ...
  mounted() {
    //DUMMY
    this.reservations = [
      {id: 1, dateFrom: new Date(2020, 12,1, 0, 0, 0, 0), dateTo: new Date(2020, 12,10), price: 200, boatName: "Zlatiborska carda", length: 10},
      {id: 2, dateFrom: new Date(2020, 7,1,1, 0, 0, 0), dateTo: new Date(2020, 7,21), price: 150, boatName: "Backa Tvrdjava", length: 20},
      {id: 3, dateFrom: new Date(2020, 6,1,1, 0, 0, 0), dateTo: new Date(2020, 6,3), price: 100, boatName: "Zlatiborska carda", length: 3},
    ];
