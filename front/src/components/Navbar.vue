<template>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; padding: 5px">
    <div class="container-fluid" style="align-items: self-start; justify-content: flex-start">
      ...
      <router-link class="btn btn-secondary m-2" :hidden="LogInService.userRole !== 'ROLE_COTTAGE_OWNER'" to="/cottageCalendar">CALENDAR</router-link>
      <router-link class="btn btn-secondary m-2" :hidden="LogInService.userRole !== 'ROLE_COTTAGE_OWNER'" to="/incomeCottage">EARNINGS REPORT</router-link>

      <!--BOAT_OWNER_ROLE-->
      <router-link class="btn btn-secondary m-2" :hidden="LogInService.userRole !== 'ROLE_BOAT_OWNER'" to="/myBoatReservation">BOAT RESERVATIONS</router-link>
      ...
      <router-link class="btn btn-secondary m-2" :hidden="LogInService.userRole !== 'ROLE_BOAT_OWNER'" to="/boatCalendar">CALENDAR</router-link>
      <router-link class="btn btn-secondary m-2" :hidden="LogInService.userRole !== 'ROLE_BOAT_OWNER'" to="/incomeBoat">EARNINGS REPORT</router-link>
    </div>
