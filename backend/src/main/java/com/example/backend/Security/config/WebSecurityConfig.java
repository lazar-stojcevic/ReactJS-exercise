...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/fishingInstructor/{id}").permitAll()
                .antMatchers("/adventure/instructor/{instructorId}").permitAll()
                .antMatchers("/cottage/{id}").permitAll()
                .antMatchers("/term/{termId}").permitAll()
                ...
                .antMatchers("/cottageReservation/nextActions/{id}").permitAll()
                .antMatchers("/boat/getAll").permitAll()
                .antMatchers("/boat/getOne/{id}").permitAll()
                .antMatchers("/boatReservation/nextActions/{id}").permitAll()
                .antMatchers("/boat/additionalServices/{boatId}").permitAll()
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("http://localhost:5173", "https://booking-tim13-frontend.herokuapp.com"); //Ovde URL frontenda
    }
